...
- [x] ~~Buttons B/C/D GPIO pins not individually hardware-confirmed~~ Confirmed: `button_listener.py`'s Pimoroni standard 4-button GPIO layout (A=5, B=6, C=16, D=24) individually verified by pressing each of B/C/D on the real board and checking the right screen mode switched each time.
